...
subtitle: "Day 2: Common Functions in R"
author: "Dr. Howard Liu"  #If multiple, 'c("A", "B")'
date: "11-01-2022"  #r Sys.Date()
output:
...
while (val <= 5){
  # statements
  print(val)
  # after displaying the value, we add 1 and redo the loop until the value reaches the condition
  val = val + 1
}
```
